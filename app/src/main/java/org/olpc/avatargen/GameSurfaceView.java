...
public class GameSurfaceView extends SurfaceView implements android.view.SurfaceHolder.Callback{
    ...
    public Bitmap takeScreenShot(boolean head) {
    	return head ? engine.takeHeadScreenshot() : engine.takeScreenShot(); 
    }
    ...
    private class RenderEngine {
        ...
        public void init(SurfaceHolder surfaceHolder, AssetDatabase db) {
        ...
        public Bitmap takeHeadScreenshot() {
        	Bitmap  bitmap = Bitmap.createBitmap(300, 300, Bitmap.Config.ARGB_8888);
    		Canvas canvas = new Canvas(bitmap);
    		android.drawHead(canvas, 300, 300);
    		return bitmap;
        }
